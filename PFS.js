...
function currentLanguage(){
    ...
    if (languageStored =='Arabic') {
        ...
        packageNameA.innerText = 'باقة باين';
        ...
        counterCard2DescriptionA.innerHTML = "<p class = 'cc1al1'>كل دور بتفاصيل مميزه</p>  <p class = 'cc1al2' >يشمل الشالية دورين</p>";  
